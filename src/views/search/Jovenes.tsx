...
import { deleteAnimalById, getAnimalsUnderTwoYears } from '../../assets/utils/asyncStorage';
...
const Jovenes = () => {
    ...
    const loadAnimal = async () => {
      try {
          const animales = await getAnimalsUnderTwoYears(String(user?.userId));
        ...
        <>
            <View style={[GlobalStyles.container, styles.container]}>
                {animals.length > 0 ? (
                    ...
                    <Text style={GlobalStyles.error}>No tienes ningun animal menor a 2 años</Text>
                )}
            </View>
