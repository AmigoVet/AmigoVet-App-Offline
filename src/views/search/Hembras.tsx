...
import { deleteAnimalById, getFemaleAnimals } from '../../assets/utils/asyncStorage';
...
const Hembras = () => {
    ...
    const loadAnimal = async () => {
      try {
          const animales = await getFemaleAnimals(String(user?.userId));
        ...
        <>
            <View style={[GlobalStyles.container, styles.container]}>
                {animals.length > 0 ? (
                    ...
                    <Text style={GlobalStyles.error}>No tienes ningun animal hembra</Text>
                )}
            </View>
